...
public class Banana {
	...
	public void tick() {
		...
		if(Player.getXPos() > 355 && Player.getXPos() < 400 && Player.getYPos() > 170 && Player.getYPos() < 200 && time > 200)
			flagga1 =false;
		...
		if(Player.getXPos() > 656 && Player.getXPos() < 710 && Player.getYPos() > 220 && Player.getYPos() < 240 && time > 200)
			flagga6 = false;
		if(Player.getXPos() > 410 && Player.getXPos() < 435 && Player.getYPos() > 560 && Player.getYPos() < 600 && time > 200) 
			flagga7 = false;
		if(Player.getXPos() > 295 && Player.getXPos() < 340 && Player.getYPos() > 270 && Player.getYPos() < 300 && time > 200) 
			flagga8 = false;
		if(Player.getXPos() > 225 && Player.getXPos() < 270 && Player.getYPos() > 170 && Player.getYPos() < 200 && time > 200) 
			flagga9 = false;
		if(Player.getXPos() > 150 && Player.getXPos() < 210 && Player.getYPos() > 450 && Player.getYPos() < 480 && time > 200) 
			flagga10 = false;
		if(Player.getXPos() > 400 && Player.getXPos() < 440 && Player.getYPos() > 420 && Player.getYPos() < 450 && time > 200) 
			flagga11 = false;
		if(Player.getXPos() > 455 && Player.getXPos() < 500 && Player.getYPos() > 450 && Player.getYPos() < 480 && time > 200) 
			flagga12 = false;
		if(Player.getXPos() > 660 && Player.getXPos() < 700 && Player.getYPos() > 510 && Player.getYPos() < 540 && time > 200) 
			flagga13 = false;
	}
	/**
