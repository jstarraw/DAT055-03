...
/**
 * 
 *This class starts the Roomstate3 itself, it brings together all the associated elemetries
 that are part of room3, i.e street lights and time taker.
...
public class RoomState3 extends States {
	...
	/**
	 * This is the constructor for the class RoomState3.
	 * 
	 * @param game,
	...
	/**
	 * Tick method will tick the components of room3 its here the Gamestate3 i build
	 ...
	 * it here the Gamestate3 is
	 * build render method override states
