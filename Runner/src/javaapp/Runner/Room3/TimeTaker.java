...
public void tick(){
	...
	if(timer > a && timer < a*2 ) flagga1 = true;
	else flagga1 = false;
	
	if(timer > a*2 && timer < a*3) flagga2 = true; 
	else flagga2 = false;
	
	if(timer > a*3 && timer < a*4) flagga3 = true; 
	else flagga3 = false;
	
	if(timer > a*4 && timer < a*5 ) flagga4 = true; 
	else flagga4 = false;

	if(timer > a*5 && timer < a*6 ) flagga5 = true; 
	
	else flagga5 = false; 
	
	if(timer > a*6 && timer < a*7) flagga6 = true;
	else flagga6 = false;

	if(timer > a*7 && timer < a*8) flagga7 = true;
	else flagga7 = false;
	
	if(timer > a*8 && timer <a*9) flagga8 = true;
	else flagga8 = false;

	if(timer > a*9 && timer < a*10) flagga9 = true;
	else flagga9 = false;
	
	if(timer > a*10 && timer < a*11) flagga10 = true;
	else flagga10 = false;
		
	if(timer > a*11 && timer < a*12) flagga11 = true; 
	else flagga11 = false;

	if(timer > a*12 && timer < a*13)flagga12 = true; 
	else flagga12 = false;
		
	
	if(timer > a*13 && timer < a*14) flagga13 = true;
	else flagga13 = false;
	
	if(timer > a*14 && timer < a*15) flagga14 = true;
	else flagga14 = false;	
...
if(flagga3)	g.drawImage(Assets.siffra3, (int) posX, (int) 75, null);
if(flagga4)	g.drawImage(Assets.siffra4, (int) posX, (int) 75, null);
if(flagga5)	g.drawImage(Assets.siffra5, (int) posX, (int) 75, null);
if(flagga6)	g.drawImage(Assets.siffra6, (int) posX, (int) 75, null);
if(flagga7)	g.drawImage(Assets.siffra7, (int) posX, (int) 75, null);
if(flagga8)	g.drawImage(Assets.siffra8, (int) posX, (int) 75, null);
if(flagga9)	g.drawImage(Assets.siffra9, (int) posX, (int) 75, null);
if(flagga10)	{
