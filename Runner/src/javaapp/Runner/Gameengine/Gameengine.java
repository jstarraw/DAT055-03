...
public class Gameengine implements Runnable {
	...
	/**
	 * Konstruktor f�r klassen gameengine.
	 * 
	 * @param title,
	...
	/**
	 * 
	 * @param Skapar displayen inititerar alla bilder och menustaten s�tter menustate till aktuell state.
	 * 
	 * 
	 */
	private void init() {
